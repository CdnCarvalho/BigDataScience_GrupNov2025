...
for num in range(1, 4):
    try:
        a = float(input(f"Digite o total de venda do vendedor {num}: "))
        b = float(input("Digite o valor da meta: "))
        resultado = calcula_atingimento(a, b)
    except ValueError:
        print("Erro!!!: Digite apenas dados numéricos para as vendas e meta.")
    except ZeroDivisionError:
        print("Erro!!!: A meta não pode ser zero.")
    else:
        print(f"Percentual de atingimento do vendedor {num}: {resultado:.2f}%")
    finally:
        print(f"Cálculo do vendedor {num} finalizado.\n")

print("Programa encerrado!")



#  ------------------------------------------------- EXEMPLO - While c/ try Exception
lst_vendas = []
resposta = 's'
venda = 1
tentativa = 1
