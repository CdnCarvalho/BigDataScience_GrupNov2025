...
# Script SQL para retornar todos os clientes
...
try:
    ...
    # Dados do banco
    df_clientes = consultar_banco(host, user, password, database, query_clientes)
    print('\nClientes:')
    print(df_clientes)

    # Dados do arquivo externo
    df_pedidos = pd.read_csv('tb_pedidos.csv')
    print('\nPedidos:')
    print(df_pedidos)
