...
min_custos = df_planilha_custos['Custo Total (R$)'].min()
max_custos = df_planilha_custos['Custo Total (R$)'].max()

# Mostrando os resultados
print()
print(60 * '-')
print("Resumo Estatístico dos Custos:")
print(f'\nTotal de custos: R$ {total_custos:.2f}')
print(f'Média dos custos: R$ {media_custos:.2f}')
print(f'Menor custo: R$ {min_custos:.2f}')
print(f'Maior custo: R$ {max_custos:.2f}')
